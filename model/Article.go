...
// 查询文章列表
func GetArtilcles(pageSize int, pageNum int) ([]Article, int) {
	var article []Article
...
// 查询指定分类下的文章列表
func GetCategoryArtilcle(categoryId int, pageSize int, pageNum int) ([]Article, int) {
	...
	return categroyArticle, errmsg.SUCCESS
}
